...
`;
  ...
  async salesChannels(@Ctx() ctx: BotContext): Promise<void> {
    ...
    text +=
      '<b>➕ Добавьте в канал админ-бота и основной бот магазина (для анимированных emoji), затем отправьте ID канала</b>';
...
<b>1. Добавьте в канал админ-бота и основной бот магазина (оба — администраторы)</b>
<b>2. Перешлите любое сообщение из канала боту @userinfobot</b>
<b>3. Скопируйте ID канала и отправьте мне</b>

<b>⚠️ Без основного бота уведомления придут, но emoji не будут анимированными</b>
    `;
